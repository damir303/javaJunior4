...
public class Main {
    public static void main(String[] args) {
        Tovar vedro = new Tovar("Ведро черрное", 100);
        Tovar kastrulya = new Tovar("кастрюля Золотая", 2000);
        Tovar plazma = new Tovar("Телик тонкий", 10000);
        Tovar styralka = new Tovar("стиралка для холостяка", 5000);

        Otziv otziv = new Otziv(5, "Ведро  супер");
        Otziv otziv1 = new Otziv(4, "Ведро не очень");
        Otziv otziv2 = new Otziv(4, "Телик супер тогкий");
        Otziv otziv3 = new Otziv(2, "не бурите это");
